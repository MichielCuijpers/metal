...
public class ToStringTest {
    ...
    public void data() {
        ...
        final ParseValue pv1 = new ParseValue("name", NONE, ImmutableList.create(new Location(0, 2)), new byte[]{1, 2}, enc());
        ...
        final ParseValue pv2 = new ParseValue("two", NONE, ImmutableList.create(new Location(0, 2)), new byte[]{3, 4}, enc());
